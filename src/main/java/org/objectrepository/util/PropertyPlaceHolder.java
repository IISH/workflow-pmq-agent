 ...
 * <p/>
 * Set the property stagingfile in a VM parameter: -Dapplication.properties=[/path/to/[filename].properties]
 * or in the CONFIG_FILE environmental property CONFIG_FILE=[/path/to/[filename].properties]
 */
public class PropertyPlaceHolder extends Properties {
    ...
    public PropertyPlaceHolder() {
        ...
        final String systemProperty = "application.properties";
        final String environmentProperty = "CONFIG_FILE";
    ...
    private static String[] EXPECT = {
            "log4j.xml", "workflow_endpoint", "workflow_endpoint_token"
    };
}
